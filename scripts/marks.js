function markError(name, quantity, sourcekind, source, edit) {
	...
	if (edit === "true") {
		...
		codemessage += '### https://github.com/astrocatalogs/kne-internal/edit/master/' + encodeURIComponent(filename) + '\n';
	...
	var win = window.open('https://github.com/astrocatalogs/kne-internal/new/master/?filename=' +
